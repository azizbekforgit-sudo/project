...
function injectStyles() {
  ...
  style.textContent = `
    /* ── Hero fullscreen (editorial white) ── */
    .hero-light {
      position: relative;
      min-height: 100vh;
      width: 100vw;
    ...
    .hero-light-inner {
      ...
      padding: clamp(100px,10vw,140px) clamp(48px,6vw,96px) clamp(60px,6vw,80px);
      width: 100%;
      display: grid;
    ...
    /* Reminder banner */
    .remind-banner {
      background: #fff9db; border: 1px solid #fbd38d; color: #744210;
